...
const Demos = () => {
  ...
  const demoData = [
    {
      ...
      thumbnail:
        "https://via.placeholder.com/300x200/4a90e2/ffffff?text=3D+Map",
    },
    {
      id: 2,
      title: "Demo 2",
      ...
      thumbnail:
        "https://via.placeholder.com/300x200/50c878/ffffff?text=Demo+2",
    },
    {
      id: 3,
      title: "Demo 3",
      ...
      thumbnail:
        "https://via.placeholder.com/300x200/ff6b6b/ffffff?text=Demo+3",
    },
  ];
  ...
  return (
    <div
      className="demos"
      style={{ padding: "0", backgroundColor: "#1a1a1a", minHeight: "100%" }}
    >
      <Container>
        <div style={{ textAlign: "center", marginBottom: "40px" }}>
          <h2
            style={{ color: "white", fontSize: "2.5rem", marginBottom: "15px" }}
          >
            Demos
          </h2>
